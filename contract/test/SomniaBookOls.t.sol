...
import "../src/SomniaBookOls.sol";

contract SomniaBookOlsTest is Test {
    SomniaBookOls public betting;
    ...
    function setUp() public {
        vm.prank(owner);
        betting = new SomniaBookOls(feeRecipient);
