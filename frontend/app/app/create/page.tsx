...
export default function CreateVaultPage() {
  ...
  const validSigners = signers.filter((signer) => signer.trim() && isValidAddress(signer))
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">Set up a new time-locked multi-signature vault</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="unlock-date" className="text-sm text-muted-foreground">
                      Date
                    </Label>
                    <Input
                      id="unlock-date"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="unlock-time" className="text-sm text-muted-foreground">
                      Time (UTC)
                    </Label>
                    <Input
                      id="unlock-time"
                    ...
                    <div key={index} className="flex gap-2">
                      <Input
                        ...
                        className={cn(
                          ...
                          signer && !isValidAddress(signer) && "border-destructive",
                        )}
                      />
                      {signers.length > 1 && (
                        <Button
          ...
          <Button
            ...
            disabled={
              !selectedToken || !amount || !unlockDate || !unlockTime || validSigners.length === 0 || isCreating
            }
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{selectedToken || "Not selected"}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-sm">
                    {unlockDate && unlockTime ? new Date(`${unlockDate}T${unlockTime}`).toLocaleString() : "Not set"}
                  </span>
                </div>
                <div className="flex justify-between">
              ...
              {validSigners.length > 0 && (
                <div className="pt-4 border-t border-border/50">
                  <Label className="text-sm text-muted-foreground mb-2 block">Valid Signers:</Label>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Once created, vault parameters cannot be changed. Ensure all details are correct before proceeding.
                  </p>
                </div>
              </div>
            </CardContent>
